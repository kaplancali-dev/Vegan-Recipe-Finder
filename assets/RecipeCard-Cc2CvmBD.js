    ...
    <article class="r-card ${m}${M}" data-recipe-id="${s.id}">
      ...
      <div class="card-body">
        ...
        <div class="r-actions">
          ...
          <button class="btn-sm btn-share share-btn" data-share-id="${s.id}" data-share-title="${l(s.title)}" data-share-url="${l(s.url||"")}">📤</button>
        </div>
      </div>
    </article>
