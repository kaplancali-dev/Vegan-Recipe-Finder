    ...
    <article class="r-card ${$}${T}" data-recipe-id="${s.id}">
      ...
      <div class="card-body">
        ...
        <div class="r-actions">
          ...
          <button class="btn-sm btn-cook cook-btn" data-cook-id="${s.id}">${h}</button>
