...
HARD_GLUTEN = [
    ...
    r'\bshaoxing\s+wine\b', r'\bshaoxing\s+rice\s+wine\b', r'\bshaoxing\s+cooking\s+wine\b', r'\bchinese\s+cooking\s+wine\b', r'\brice\s+cooking\s+wine\b',
    r'\bwheat\s+starch\b', r'\bwheat\s+flakes\b',
