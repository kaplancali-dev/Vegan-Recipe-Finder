...
export function shareRecipe(title, url, id) {
  ...
  const text = title
    ? `Check out "${title}" on HARVEST™ 🌿 — See what your kitchen already knows. Over 4,000 gluten-free recipes matched to what's in your fridge.`
    : `HARVEST™ 🌿 — See what your kitchen already knows. Over 4,000 gluten-free recipes matched to what's in your fridge.`;
