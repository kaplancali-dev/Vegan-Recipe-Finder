...
const STEPS = [
  ...
  },
  {
    ...
    body: 'Every recipe shows how many ingredients you already have. Search for anything — like "pancakes" — and filter by category or cook time. A new Recipe of the Day is spotlighted at the top.',
    arrow: 'top',
  },
  {
    target: '#sortBar',
  ...
  },
  {
    ...
    body: 'Add recipes to My Queue to plan meals. When you\'re ready to shop, tap 🛒 to send ingredients to your shopping list.',
    arrow: 'top',
  },
  {
    target: '#btn-favorites',
    tab: 'favorites',
    title: 'Save and track recipes',
    body: 'Tap ❤️ on any recipe to save it here. Organize into collections like Weekly Meal Plan or Game Day. Your Made It journal tracks every dish you\'ve cooked with star ratings.',
    arrow: 'top',
  },
  {
    target: '#btn-shopping',
    ...
    body: 'Send recipes from My Queue to Shopping. HARVEST shows exactly what you\'re missing — organized by recipe. Tap 📤 to share the list with anyone.',
    arrow: 'top',
  },
  {
    target: '#btn-browse',
    tab: 'browse',
    title: 'Rate, share, and repeat',
    body: 'After cooking, tap ✅ I Made This on any recipe to rate it 1–5 stars. You\'ll get an option to share it with a friend — and it\'s saved to your cooking journal automatically.',
    arrow: 'top',
  },
];
