...
export const STAPLE_SECTIONS = [
  ...
  { label: '🫘 Beans & Legumes', sub: 'the workhorses', items: [
    ...
    { name: 'firm tofu', hint: 'holds shape, for stir-fries & baking' },
    { name: 'extra-firm tofu', hint: 'densest, for grilling & frying' },
    { name: 'soft tofu', hint: 'between silken and firm, for scrambles' },
    { name: 'silken tofu', hint: 'blends smooth (sauces, dressings, desserts)' },
    'tempeh','edamame',
  ...
  { label: '🌾 Grains & Starches', sub: 'the carb committee', items: [
    ...
    'corn tortillas',
    { name: 'polenta', hint: 'coarse cornmeal, for the porridge dish' },
    'cornmeal',
    { name: 'masa harina', hint: 'corn flour for tortillas/tamales (not cornmeal)' },
    { name: 'buckwheat', hint: 'gluten-free despite the name' },
  ...
  { label: '🥜 Nuts & Seeds', sub: 'creamy dreams', items: [
    ...
    { name: 'tahini', hint: 'ground sesame paste (hummus, dressings, baking)' },
  ...
  { label: '🫒 Oils & Fats', sub: 'the slip-and-slide section', items: [
    ...
    { name: 'sesame oil', hint: 'for cooking (not the toasted finishing kind)' },
    'chili oil',
    { name: 'vegan butter', hint: "yes it melts, yes it's real" },
    'vegetable oil',
    { name: 'toasted sesame oil', hint: 'for drizzling/finishing, not high heat' },
  ...
  { label: '🫙 Sauces & Condiments', sub: 'the personality section', items: [
    ...
    { name: 'liquid smoke', hint: 'drops add smoky bacon-y flavor' },
    'vegan sour cream',
  ...
  { label: '🧂 Baking & Flours', sub: 'for your ambitious Sunday self', items: [
    ...
    { name: 'coconut flour', hint: 'very absorbent — recipes use way less than other flours' },
    'oat flour',
    'tapioca flour','brown rice flour','chickpea flour','cassava flour',
    'flaxseed meal','applesauce',
    { name: 'aquafaba', hint: 'chickpea brine, vegan egg-white substitute' },
    { name: 'agar powder', hint: 'vegan gelatin (sets liquids)' },
    'psyllium husk',
