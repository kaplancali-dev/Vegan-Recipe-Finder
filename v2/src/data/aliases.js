...
export const QA_ITEMS = [
  {cat:'🫘 Beans & Legumes',     items:['chickpeas','black beans','lentils','kidney beans','cannellini beans','great northern beans','navy beans','butter beans','lima beans','pinto beans','mung beans','split peas','black-eyed peas',{name:'firm tofu',hint:'holds shape, for stir-fries & baking'},{name:'extra-firm tofu',hint:'densest, for grilling & frying'},{name:'soft tofu',hint:'between silken and firm, for scrambles'},{name:'silken tofu',hint:'blends smooth (sauces, dressings, desserts)'},'tempeh','edamame','jackfruit','TVP','soy curls']},
  {cat:'🌾 Grains & Starches',  items:['GF pasta (any)','rice (any)','quinoa','oats','millet','sweet potatoes','potatoes','corn tortillas',{name:'polenta',hint:'coarse cornmeal, for the porridge dish'},'cornmeal',{name:'masa harina',hint:'corn flour for tortillas/tamales (not cornmeal)'},{name:'buckwheat',hint:'gluten-free despite the name'},'rice noodles','glass noodles','nori','gnocchi','GF bread','GF breadcrumbs','GF tortillas']},
  ...
  {cat:'🍋 Fruits',             items:['lemon','lime','banana','berries (any)','cranberries','cherries','mango','apple','oranges','orange juice','pineapple','peaches','pears','kiwi','papaya','pomegranate','plantain','figs','grapes','watermelon','coconut','dates','raisins','dried apricots',{name:'date paste',hint:'blended dates for sweetening (no refined sugar)'}]},
  {cat:'🥜 Nuts & Seeds',       items:['nut butter (any)','cashews','almonds','walnuts','pecans','brazil nuts','macadamia nuts','hazelnuts','pistachio','peanuts','sesame seeds','pine nuts',{name:'tahini',hint:'ground sesame paste (hummus, dressings, baking)'},'hemp seeds','chia seeds','flax seeds','pumpkin seeds','sunflower seeds','protein powder']},
  ...
  {cat:'🫒 Oils & Fats',         items:['olive oil','coconut oil','avocado oil',{name:'sesame oil',hint:'for cooking (not the toasted finishing kind)'},'chili oil','vegan butter','vegetable oil',{name:'toasted sesame oil',hint:'for drizzling/finishing, not high heat'},'sunflower oil','grapeseed oil','peanut oil']},
  ...
  {cat:'🫙 Sauces & Condiments', items:['tamari / coconut aminos','miso paste','vegan mayo','ketchup','yellow mustard','dijon mustard','BBQ sauce','hoisin sauce','vegan worcestershire','tamarind paste','harissa paste','gochujang','sriracha / hot sauce','sambal oelek','curry paste',{name:'liquid smoke',hint:'drops add smoky bacon-y flavor'},'vegan sour cream','nutritional yeast',{name:'tahini',hint:'ground sesame paste (hummus, dressings, baking)'},'nut butter (any)','cornstarch','arrowroot powder']},
  {cat:'🍯 Sweeteners & Vinegars', items:['maple syrup','natural sweetener (any)','agave nectar','coconut sugar','brown sugar','cane sugar','powdered sugar','date syrup','molasses','coconut nectar',{name:'allulose',hint:'use like sugar (1:1, bakes & browns)'},{name:'stevia / monk fruit',hint:'tiny drops, best for drinks (no bulk for baking)'},'apple cider vinegar','rice vinegar','balsamic vinegar','white vinegar','red wine vinegar','white wine vinegar','sherry vinegar','red wine','white wine']},
  {cat:'🧂 Baking & Flours',    items:['baking soda','baking powder','cornstarch','arrowroot powder','gluten-free flour','almond flour',{name:'coconut flour',hint:'very absorbent — recipes use way less than other flours'},'oat flour','tapioca flour','brown rice flour','chickpea flour','cassava flour','flaxseed meal','applesauce',{name:'aquafaba',hint:'chickpea brine, vegan egg-white substitute'},{name:'agar powder',hint:'vegan gelatin (sets liquids)'},'psyllium husk','xanthan gum','almond extract','vanilla extract','cocoa powder','coconut oil','vegan butter','matcha','cream of tartar','active dry yeast','protein powder']},
