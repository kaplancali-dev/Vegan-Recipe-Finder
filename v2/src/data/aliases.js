...
export const QA_ITEMS = [
  ...
  {cat:'🍨 Dessert Pantry',     items:['vanilla extract','cocoa powder','chocolate chips (any)','white chocolate chips','dark chocolate','cacao nibs','cacao butter','coconut cream','shredded coconut','date sugar','allulose','stevia / monk fruit']},
