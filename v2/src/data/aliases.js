...
export const QA_ITEMS = [
  ...
  {cat:'🥫 Canned & Jarred',    items:['canned tomatoes (any)','tomato sauce','tomato paste','vegetable broth','coconut milk','olives','artichoke hearts','roasted red peppers','sun-dried tomatoes','capers','salsa','hummus','sauerkraut','instant coffee','cooking spray','hearts of palm','yellow cornmeal']},
  ...
  {cat:'🧂 Baking & Flours',    items:['baking soda','baking powder','cornstarch','arrowroot powder','gluten-free flour','almond flour','coconut flour','oat flour','tapioca flour','brown rice flour','chickpea flour','cassava flour','flaxseed meal','applesauce','aquafaba','agar powder','psyllium husk','xanthan gum','almond extract','matcha','cacao butter','vegan puff pastry','gnocchi','cream of tartar','active dry yeast','protein powder']},
